<?php
	...
	*/
	...
	define('GALLERY_ROOT', './');
	define('DATA_ROOT', '_gallery_data/');
	define('SECURITY_PHRASE', '8G6sKs3uNygmOpmBBk3atlddtrRWPR');
	define('PASSWORD', '');
	define('ADMIN', FALSE); // TRUE or FALSE
	...
	$dir_exclude = array('_sfpg_data', '_sfpg_icons', '_gallery_data');
	...
	$file_exclude = array();
	$file_ext_exclude = array('.php', '.txt', '.sell', '.lnk', '.ini');
